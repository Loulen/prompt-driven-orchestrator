...
//!
//! Maestro bounds the number of live NodeRun (Claude Code) tmux sessions
...
pub const SESSION_CAP_ENV: &str = "MAESTRO_SESSION_CAP";

/// Default global cap on concurrent NodeRun sessions.
///
/// Chosen below the ~30-session point where the tmux server was observed to
