...
const STEPS: TourStep[] = [
  ...
  },
  {
    ...
    target: (app) => nodeSel(agent(app, 0)),
  ...
  },
  {
    ...
    target: (app) => nodeSel(agent(app, 1)),
  ...
  },
  {
    ...
    target: (app) => [...nodeSel(agent(app, 0)), ...nodeSel(agent(app, 1))],
  ...
  },
  {
    ...
    target: (app) => [...nodeSel(agent(app, 1)), ...nodeSel(agent(app, 0))],
    waitingFor: "the two agent cards",
  ...
  },
  {
    ...
    target: (app) => edgeSel(app, agent(app, 1), agent(app, 0)),
  ...
  },
  {
    ...
    target: (app) => [...nodeSel(agent(app, 1)), ...nodeSel(endNode(app))],
  ...
  },
  {
    ...
    target: (app) => edgeSel(app, agent(app, 1), endNode(app)),
  ...
  },
  {
    ...
    target: (app) => (app.pipelineId ? [`[data-testid="library-row-${cssEscape(app.pipelineId)}"]`] : []),
