...
When two browsers show the same terminal (node, Manager, library assistant or Run shell), only one of them pilots it (#867, [ADR-0075](docs/adr/0075-un-terminal-partage-n-a-qu-un-pilote-qui-seul-pese-sur-la-taille.md)). This stops the flicker of a tmux window resized by each browser in turn.
